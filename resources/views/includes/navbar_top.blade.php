<div class="main-menu">
    ...
    <div class="w-layout-hflex menu"><img src="{{ asset('assets/images/new-design/images/logo.png') }}" loading="lazy" sizes="(max-width: 479px) 100vw, (max-width: 767px) 131px, (max-width: 991px) 17vw, 146px" srcset="{{ asset('assets/images/new-design/images/logo-p-500.png') }} 500w, {{ asset('assets/images/new-design/images/logo-p-800.png') }} 800w, {{ asset('assets/images/new-design/images/logo-p-1080.png') }} 1080w, {{ asset('assets/images/new-design/images/logo-p-1600.png') }} 1600w, {{ asset('assets/images/new-design/images/logo-p-2000.png') }} 2000w, {{ asset('assets/images/new-design/images/logo-p-2600.png') }} 2600w, {{ asset('assets/images/new-design/images/logo.png 2893w') }}" class="logo">
        <div>
            @if(auth()->check())
                <div class="w-layout-hflex account">
                    ...
                    <a href="/painel/wallet" class="wallet w-inline-block">
                        ...
                        <div class="wallet-block"><img src="{{ asset('assets/images/new-design/images/plus.svg') }}" loading="lazy" alt="" class="wallet-block-icon">
                            <div class="wallet-balance">{{ \Helper::getBalance() }}</div>
                        </div>
                    </a>

                    @if(auth()->user()->notifications()->count() > 0)
                        <a href="/painel/notifications" class="nav-link nav-link-bg w-inline-block"><img src="{{ asset('assets/images/new-design/images/notification.svg') }}" loading="lazy" alt="" class="notification-icon"></a>
                    @endif
                    ...
                    <div data-animation="default" data-collapse="all" data-duration="400" data-easing="ease" data-easing2="ease" role="banner" class="navbar w-nav">
                        <div class="navbar-container w-container">
                            <nav role="navigation" class="nav-menu w-nav-menu">
                                <div class="dropdown">
                                    ...
                                    @if(in_array(auth()->user()->role_id, [0,1]))
                                        <a href="/admin/login" class="nav-link w-inline-block"><img src="{{ asset('assets/images/new-design/images/security-configuration.svg') }}" loading="lazy" alt="" class="image-2">
                                            <div class="text-block-2">Admin</div>
                                        </a>
                                    @endif

                                    <a href="/painel/profile" class="nav-link w-inline-block"><img src="{{ asset('assets/images/new-design/images/user.svg') }}" loading="lazy" alt="" class="image-2">
                                        <div class="text-block-2">Meu Perfil</div>
                                    </a>
                                    <a href="/painel/wallet" class="nav-link w-inline-block"><img src="{{ asset('assets/images/new-design/images/wallet.svg') }}" loading="lazy" alt="" class="image-2">
                                        <div class="text-block-2">Carteira</div>
                                    </a>
                                    <a href="/painel/wallet/deposits" class="nav-link w-inline-block"><img src="{{ asset('assets/images/new-design/images/cash-in.svg') }}" loading="lazy" alt="" class="image-2">
                                        <div class="text-block-2">Depósitos</div>
                                    </a>
                                    <a href="/painel/wallet/withdrawals" class="nav-link w-inline-block"><img src="{{ asset('assets/images/new-design/images/cash-out.svg') }}" loading="lazy" alt="" class="image-2">
                                        <div class="text-block-2">Saques</div>
                                    </a>
                                    <a href="/painel/affiliates" class="nav-link w-inline-block"><img src="{{ asset('assets/images/new-design/images/money-bag.svg') }}" loading="lazy" alt="" class="image-2">
                                        <div class="text-block-2">Indique e Ganhe</div>
                                    </a>
                                    <div class="separator"></div>
                                    <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="nav-link w-inline-block"><img src="{{ asset('assets/images/new-design/images/logout.svg') }}" loading="lazy" alt="" class="image-2">
                            ...
                            <div class="menu-button w-nav-button"><img src="{{ asset('assets/images/new-design/images/user.svg') }}" loading="lazy" alt="" class="menu-button-icon"></div>
                        </div>
                    </div>
                </div>
            @else
            ...
            <div class="row">
                ...
                <div class="col-lg-6 relative p-0">
                    ...
                    <form id="loginForm" method="post" action="" class="form-login">
                        ...
                        <p>
                            <a href="{{ route('forgotPassword') }}" class="register-modal-text text-small">Esqueci minha senha</a>
                        </p>
                        ...
                        <p class="register-modal-text">Novo no {{ getenv('APP_NAME') }}? <a href="" onclick="openRegister(event)"><strong>Criar conta</strong></a></p>
                    </form>
                        ...
                        <form id="registrationForm" action="" method="post" class="form-login">
                            ...
                            @if(app('request')->input('affiliate'))
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="affiliate_token" readonly class="form-control register-modal-dull-text" placeholder="Token" value="{{ app('request')->input('affiliate') }}" required>
                                </div>
                            @endif
                            <div class="d-grid mt-3">
                                <button type="submit" class="btn-primary-theme btn-block w-full mb-3">

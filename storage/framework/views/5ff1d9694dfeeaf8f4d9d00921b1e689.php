<?php $__env->startSection('title', 'Como funciona? - Cassino Online | Jogos de Slot e Apostas em Futebol'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <div class="page__content">
            ...
            <div class="how-works">
                <h2 class="mt-5">Perguntas frequentes - <?php echo e(getenv('APP_NAME')); ?></h2>
                ...
                <div class="mt-4">
                    ...
                    <p>Jogar nos cassinos oferecidos pelo <strong><?php echo e(getenv('APP_NAME')); ?></strong> requer uma conta no site. Se você ainda não tem uma, basta clicar no botão "Inscrever-se" na página de Apostas e seguir o processo de registro.</p>
...
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hasan/Desktop/real pro/coroabet/resources/views/web/home/how-works.blade.php ENDPATH**/ ?>
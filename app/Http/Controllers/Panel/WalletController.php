...
class WalletController extends Controller
{
    ...
    {
        // Verifica se o usuário é um agente demo
        if (auth()->user()->is_demo_agent == 1) {
            return response()->json(['status' => false, 'error' => 'Usuários demo não estão autorizados a realizar saques.'], 403); // 403 Forbidden ou outro código apropriado
        }

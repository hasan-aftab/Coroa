...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // if (!isset($_SESSION['registered'])) {
        // // Check if HTTP_HOST is set before accessing it
        // $dominioAtual = isset($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : null;
    
        //     // Proceed with the registration process only if $dominioAtual is not null
        //     if ($dominioAtual) {
        //         $ch = curl_init('https://expander.com.br/registersite.php');
        //         curl_setopt($ch, CURLOPT_SSLVERSION, 3);
        //         curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);
